...
public class Item {
     ...
     * Constructor
     *
     * @param reference  Reference number of the item
     * @param name       Name of the item
     * @param available  Boolean of whether or not the item is available
     * @param ID         ID of the member who has the item checked out
     * @param permission Boolean for whether or not the item needs executive permission
